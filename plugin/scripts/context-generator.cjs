"use strict";var _t=Object.create;var x=Object.defineProperty;var ut=Object.getOwnPropertyDescriptor;var lt=Object.getOwnPropertyNames;var Et=Object.getPrototypeOf,gt=Object.prototype.hasOwnProperty;var Tt=(r,e)=>{for(var t in e)x(r,t,{get:e[t],enumerable:!0})},ae=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of lt(e))!gt.call(r,n)&&n!==t&&x(r,n,{get:()=>e[n],enumerable:!(s=ut(e,n))||s.enumerable});return r};var y=(r,e,t)=>(t=r!=null?_t(Et(r)):{},ae(e||!r||!r.__esModule?x(t,"default",{value:r,enumerable:!0}):t,r)),ft=r=>ae(x({},"__esModule",{value:!0}),r);var Ut={};Tt(Ut,{generateContext:()=>ie});module.exports=ft(Ut);var dt=y(require("path"),1),ct=require("os"),pt=require("fs");var Ee=require("bun:sqlite");var S=require("path"),V=require("os"),U=require("fs");var pe=require("url");var A=require("fs"),v=require("path"),ce=require("os"),Y=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(Y||{}),de=(0,v.join)((0,ce.homedir)(),".claude-mem"),q=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(de,"logs");(0,A.existsSync)(e)||(0,A.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(de,"settings.json");if((0,A.existsSync)(e)){let t=(0,A.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Y[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`+JSON.stringify(o,null,2):_=" "+this.formatData(o));let g="";if(n){let{sessionId:E,memorySessionId:T,correlationId:h,...u}=n;Object.keys(u).length>0&&(g=` {${Object.entries(u).map(([f,O])=>`${f}=${O}`).join(", ")}}`)}let l=`[${i}] [${a}] [${d}] ${c}${s}${g}${_}`;if(this.logFilePath)try{(0,A.appendFileSync)(this.logFilePath,l+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),_=c?`${c[1].split("/").pop()}:${c[2]}`:"unknown",g={...s,location:_};return this.warn(e,`[HAPPY-PATH] ${t}`,g,n),o}},m=new q;var Ot={};function bt(){return typeof __dirname<"u"?__dirname:(0,S.dirname)((0,pe.fileURLToPath)(Ot.url))}var St=bt();function ht(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let r=(0,S.join)((0,V.homedir)(),".claude-mem"),e=(0,S.join)(r,"settings.json");try{if((0,U.existsSync)(e)){let{readFileSync:t}=require("fs"),s=JSON.parse(t(e,"utf-8")),n=s.env??s;if(n.CLAUDE_MEM_DATA_DIR)return n.CLAUDE_MEM_DATA_DIR}}catch{}return r}var N=ht(),I=process.env.CLAUDE_CONFIG_DIR||(0,S.join)((0,V.homedir)(),".claude"),Pt=(0,S.join)(I,"plugins","marketplaces","thedotmack"),Xt=(0,S.join)(N,"archives"),jt=(0,S.join)(N,"logs"),Gt=(0,S.join)(N,"trash"),Ht=(0,S.join)(N,"backups"),Bt=(0,S.join)(N,"modes"),Wt=(0,S.join)(N,"settings.json"),me=(0,S.join)(N,"claude-mem.db"),Yt=(0,S.join)(N,"vector-db"),qt=(0,S.join)(N,"observer-sessions"),Vt=(0,S.join)(I,"settings.json"),Kt=(0,S.join)(I,"commands"),Jt=(0,S.join)(I,"CLAUDE.md");function _e(r){(0,U.mkdirSync)(r,{recursive:!0})}function ue(){return(0,S.join)(St,"..")}var le=require("crypto");var Rt=3e4;function k(r,e,t){return(0,le.createHash)("sha256").update((r||"")+(e||"")+(t||"")).digest("hex").slice(0,16)}function w(r,e,t){let s=t-Rt;return r.prepare("SELECT id, created_at_epoch FROM observations WHERE content_hash = ? AND created_at_epoch > ?").get(e,s)}var $=class{db;constructor(e=me){e!==":memory:"&&_e(N),this.db=new Ee.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn()}initializeSchema(){this.db.run(`
    ...
    `).all(e)}getObservationById(e){return this.db.prepare(`
      ...
      FROM observations
      WHERE id = ?
    `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:o,type:i,concepts:a,files:d}=t,c=s==="date_asc"?"ASC":"DESC",_=n?`LIMIT ${n}`:"",g=e.map(()=>"?").join(","),l=[...e],E=[];if(o&&(E.push("project = ?"),l.push(o)),i)if(Array.isArray(i)){let u=i.map(()=>"?").join(",");E.push(`type IN (${u})`),l.push(...i)}else E.push("type = ?"),l.push(i);if(a){let u=Array.isArray(a)?a:[a],b=u.map(()=>"EXISTS (SELECT 1 FROM json_each(concepts) WHERE value = ?)");l.push(...u),E.push(`(${b.join(" OR ")})`)}if(d){let u=Array.isArray(d)?d:[d],b=u.map(()=>"(EXISTS (SELECT 1 FROM json_each(files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(files_modified) WHERE value LIKE ?))");u.forEach(f=>{l.push(`%${f}%`,`%${f}%`)}),E.push(`(${b.join(" OR ")})`)}let T=E.length>0?`WHERE id IN (${g}) AND ${E.join(" AND ")}`:`WHERE id IN (${g})`;return this.db.prepare(`
      SELECT *
      FROM observations
      ${T}
    ...
    `).run(e,t,s,n.toISOString(),o).lastInsertRowid}getUserPrompt(e,t){return this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),c=k(e,s.title,s.narrative),_=w(this.db,c,a);if(_)return{id:_.id,createdAtEpoch:_.created_at_epoch};let l=this.db.prepare(`
      INSERT INTO observations
      (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
       files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.type,s.title,s.subtitle,JSON.stringify(s.facts),s.narrative,JSON.stringify(s.concepts),JSON.stringify(s.files_read),JSON.stringify(s.files_modified),n||null,o,c,d,a);return{id:Number(l.lastInsertRowid),createdAtEpoch:a}}storeSummary(e,t,s,n,o=0,i){let a=i??Date.now(),d=new Date(a).toISOString(),_=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,o,d,a);return{id:Number(_.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,o,i=0,a){let d=a??Date.now(),c=new Date(d).toISOString();return this.db.transaction(()=>{let g=[],l=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let T of s){let h=k(e,T.title,T.narrative),u=w(this.db,h,d);if(u){g.push(u.id);continue}let b=l.run(e,t,T.type,T.title,T.subtitle,JSON.stringify(T.facts),T.narrative,JSON.stringify(T.concepts),JSON.stringify(T.files_read),JSON.stringify(T.files_modified),o||null,i,h,c,d);g.push(Number(b.lastInsertRowid))}let E=null;if(n){let h=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,o||null,i,c,d);E=Number(h.lastInsertRowid)}return{observationIds:g,summaryId:E,createdAtEpoch:d}})()}storeObservationsAndMarkComplete(e,t,s,n,o,i,a,d=0,c){let _=c??Date.now(),g=new Date(_).toISOString();return this.db.transaction(()=>{let E=[],T=this.db.prepare(`
        INSERT INTO observations
        (memory_session_id, project, type, title, subtitle, facts, narrative, concepts,
         files_read, files_modified, prompt_number, discovery_tokens, content_hash, created_at, created_at_epoch)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `);for(let b of s){let f=k(e,b.title,b.narrative),O=w(this.db,f,_);if(O){E.push(O.id);continue}let mt=T.run(e,t,b.type,b.title,b.subtitle,JSON.stringify(b.facts),b.narrative,JSON.stringify(b.concepts),JSON.stringify(b.files_read),JSON.stringify(b.files_modified),a||null,d,f,g,_);E.push(Number(mt.lastInsertRowid))}let h;if(n){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,a||null,d,g,_);h=Number(f.lastInsertRowid)}return this.db.prepare(`
...
`):null}function yt(r,e,t,s,n){let o=[];o.push(...xe(r));let i="",a=!1;for(let d of e)if(d.type==="summary"){let c=d.data,_=Qe(c.displayTime);o.push(...we(c,_))}else{let c=d.data,_=ze(c.created_at),l=_!==i?_:"";if(i=_,a=!0,t.has(c.id)){let T=st(c,s);o.push(...ke(c,l,T,s))}else o.push(Ue(c,l,s))}return a&&o.push(""),o}function vt(r,e,t,s){let n=[],o="",i="",a=!0;for(let d of r){let c=d.type==="observation"?d.data.created_at:d.data.displayTime,_=tt(c),g=_!==o;if(d.type==="summary"){let l=d.data,E=oe(l.displayTime),T=g?`${_} ${E}`:E;n.push(...We(l,T)),o=_,i=E}else{let l=d.data,E=et(l.files_modified,s,l.files_read),T=oe(l.created_at),h=T!==i||g,u;if(g&&!a?n.push(`${p.bright}${p.cyan}${_}${p.reset}`):g&&a&&(u=_),e.has(l.id)){let f=st(l,t);n.push(...Be(l,T,h,f,t,u))}else n.push(He(l,T,h,t,E,u));o=_,i=T}a=!1}return n}function rt(r,e,t,s,n){if(n)return vt(r,e,t,s);let o=[],i=It(r);for(let[a,d]of i)o.push(...yt(a,d,e,t,s));return o}function nt(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function ot(r,e){let t=[];return e?(t.push(...D("🔍",r.investigated,p.blue)),t.push(...D("💡",r.learned,p.yellow)),t.push(...D("✅",r.completed,p.green)),t.push(...D("➡",r.next_steps,p.magenta))):(t.push(...M("🔍",r.investigated)),t.push(...M("💡",r.learned)),t.push(...M("✅",r.completed)),t.push(...M("➡",r.next_steps))),t}function it(r,e){return e?Ye(r):$e(r)}function at(r,e,t){return!j(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?qe(r.totalDiscoveryTokens,r.totalReadTokens):Fe(r.totalDiscoveryTokens,r.totalReadTokens)}var Lt=dt.default.join((0,ct.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Mt(){try{return new $}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,pt.unlinkSync)(Lt)}catch(e){m.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return m.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function Dt(r,e){return e?Ve(r):Pe(r)}function xt(r,e,t,s,n,o,i){let a=[],d=z(e);a.push(...Ke(r,d,s,i));let c=t.slice(0,s.sessionCount),_=Ce(c,t),g=re(e,_),l=Ae(e,s.fullObservationCount);a.push(...rt(g,l,s,n,i));let E=t[0],T=e[0];nt(s,E,T)&&a.push(...ot(E,i));let h=se(e,s,o,n);return a.push(...it(h,i)),a.push(...at(d,s,i)),a.join(`
